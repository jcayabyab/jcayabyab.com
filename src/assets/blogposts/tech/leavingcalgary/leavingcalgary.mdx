...
But why is that such a big dream? Why are so many young Calgarian oftware developers so allured by tech companies elsewhere? In fact, the only demographic that’s experienced a population decline is young adults from 20-24, which is around the age of when most university students graduate and move on to the workforce.s
...
<div style="margin-bottom: 1em;">
  <small>
    You can see my sources and calculations for these salary figures <a href="http://bit.ly/388bQzk" target="_blank">here</a>.
  </small>
</div>
